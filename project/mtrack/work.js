        ...
        function work(option){
          ...
          var sum =document.getElementById('sum')
           ...
           if(option === "redtea"){
              table.innerHTML = table.innerHTML + "<tr id ='tr"+i+"'><td>紅茶</td><td id='one"+i+"'>20</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>20</td></tr>"
              i++
              M.push("20")
             sum.innerText=parseInt(sum.innerText)+parseInt("20")
           }
           if(option === "greentea"){
            table.innerHTML = table.innerHTML + "<tr><td>綠茶</td><td id='one"+i+"'>25</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>25</td></tr>"
            i++
            M.push("25")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("25")
           }
           if(option === "tea"){
            table.innerHTML = table.innerHTML + "<tr><td>青茶</td><td id='one"+i+"'>25</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>25</td></tr>"
            i++
            M.push("25")
            sum.innerText=parseInt(sum.innerText)+parseInt("25")
           }
           if(option === "honey"){
            table.innerHTML = table.innerHTML + "<tr><td>蜜茶</td><td id='one"+i+"'>30</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>30</td></tr>"
            i++
            M.push("30")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("30")
           }
           if(option === "ol3"){
            table.innerHTML = table.innerHTML + "<tr><td>阿里山烏龍茶</td><td id='one"+i+"'>35</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>35</td></tr>"
            i++
            M.push("35")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("35")
           }
           if(option === "tp"){
            table.innerHTML = table.innerHTML + "<tr><td>炭培烏龍茶</td><td id='one"+i+"'>35</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>35</td></tr>"
            i++
            M.push("35")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("35")
           }
           if(option === "fire"){
            table.innerHTML = table.innerHTML + "<tr><td>烤茶</td><td id='one"+i+"'>40</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>40</td></tr>"
            i++
            M.push("40")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("40")
           }
           if(option === "ice"){
            table.innerHTML = table.innerHTML + "<tr><td>冰淇淋紅茶</td><td id='one"+i+"'>45</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>45</td></tr>"
            i++
            M.push("45")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("45")
           }
           if(option === "Guanyin"){
            table.innerHTML = table.innerHTML + "<tr><td>鐵觀音</td><td id='one"+i+"'>40</td><td><input id='i"+i+"' type='Text' value='1'></td><td id='price"+i+"'>40</td></tr>"
            i++
            M.push("40")
            sum.innerHTML=parseInt(sum.innerText)+parseInt("40")
           }
